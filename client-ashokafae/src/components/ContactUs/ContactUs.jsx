        ...
        <section className="bg-[#d2f0e4] py-12 px-6 pt-20">
            <div className="container mx-auto flex flex-col md:flex-row justify-center gap-12">
                ...
                <div className="bg-gray-100 p-10 rounded-lg shadow-md w-full md:w-1/3">
                    <h2 className="text-4xl tracking-wider font-bold font-rochester text-green-700 mb-3">Contact Info :</h2>
                    <hr className="border-green-500 mb-4 w-2/5" />
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-md w-full md:w-1/3">
                    <h2 className="text-4xl tracking-wider font-bold text-green-700 mb-3 font-rochester">How We Can Serve You ?</h2>
                    <hr className="border-green-500 mb-4 w-3/5" />
                    <form className="space-y-6">
                        ...
                        <button className="w-full bg-green-500 text-white py-3 px-6 rounded-md shadow-md hover:bg-green-700 transition duration-300 transform hover:scale-105">
                            SEND MESSAGE
                        </button>
                    </form>
                </div>
