        ...
        <div className="min-h-screen">
            ...
            <section className="w-full bg-gray-100 flex justify-center py-16 md:py-24 pt-28" id="second-page">
                <div className="container mx-auto flex flex-col md:flex-row items-center px-5 md:px-24">
                    ...
                    {/* Left Side - Image */}
                    <div className="md:w-[500px] w-full flex justify-center mb-5 md:mb-0">
                        <img
                            src="https://plus.unsplash.com/premium_photo-1691030256235-47d75d5890b9?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8YnJpZGUlMjBhbmQlMjBncm9vbSUyMGluZGlhbiUyMHdlZGRpbmd8ZW58MHx8MHx8fDA%3D"
                            alt="Wedding Couple"
                    ...
                    <div className="md:w-[500px] w-full flex flex-col md:ml-12 text-left">
                        ...
                        {/* Headline */}
                        <h3 className="text-gray-900 font-bold text-lg md:text-xl uppercase mb-2 tracking-wider">ASHOKA</h3>
