...
const AuthPage = () => {
    ...
    return (
        <div className="flex items-center justify-center sticky min-h-screen top-20 bg-gray-100">
            {/* Main Container */}
            <div className="flex flex-col lg:flex-row w-[90%] md:w-[80%] lg:w-[70%] shadow-lg rounded-lg overflow-hidden bg-white">
                {/* Left Section */}
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full text-white text-center p-2 lg:p-4">
                        ...
                        <div className="flex flex-col items-center justify-center flex-1">
                            <button
                                ...
                                className="w-32 h-12 bg-white text-black py-2 rounded-lg text-base font-medium hover:bg-gray-200 transition-colors mt-4 cursor-pointer"
                            >
