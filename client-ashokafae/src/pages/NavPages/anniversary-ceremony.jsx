...
const anniversaryFeatures = [
    {
        ...
        description: 'Create memorable moments that reflect your journey together.',
    },
    {
        icon: Gift,
        title: 'Elegant Decor',
        description: 'Beautiful themes tailored to your love story.',
    },
    {
        icon: Smile,
        title: 'Stress-Free Planning',
        description: 'Let us handle everything while you enjoy your day.',
    },
];

export default function AnniversaryCeremony() {
    return (
        <EventCategoryPage
            category="Anniversary"
            heroImage="https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&q=80"
            title="Celebrate Years of Love"
            subtitle="Make your anniversary celebration as special as your journey together"
            buttonText="Plan Anniversary"
            featureList={anniversaryFeatures}
        />
    );
}
