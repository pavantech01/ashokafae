...
const weddingFeatures = [
    {
        ...
        description: 'Custom themes and decor tailored to your love story.',
    },
    {
        icon: Package,
    ...
    },
    {
        icon: Star,
        title: 'Expert Team',
        description: 'Professional planners dedicated to your vision.',
    },
];
...
export default function WeddingEvent() {
    return (
        <EventCategoryPage
            ...
            title="Create Your Dream Wedding"
            subtitle="Let us transform your special day into an unforgettable celebration of love"
            buttonText="Plan Your Wedding"
            featureList={weddingFeatures}
        />
    );
}
