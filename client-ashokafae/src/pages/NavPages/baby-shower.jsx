...
const babyShowerFeatures = [
    {
        icon: Heart,
        title: 'Personalized Touch',
        description: 'Custom themes and decorations tailored to your vision.',
    },
    {
        icon: Package,
    ...
    },
    {
        ...
        description: 'Experienced team dedicated to your special day.',
    },
];
...
export default function BabyShower() {
    return (
        <EventCategoryPage
            ...
            heroImage="https://images.unsplash.com/photo-1616843777726-2b35ac7c4215?q=80&w=2070&auto=format&fit=crop"
            title="Create Magical Moments for Your Little One"
            subtitle="Celebrate with curated baby shower experiences"
            buttonText="Plan Baby Shower"
            featureList={babyShowerFeatures}
        />
    );
}
