...
import { Droplet, Star, Leaf } from 'lucide-react';

const haldiFeatures = [
    {
        icon: Droplet,
        title: 'Traditional Colors',
        description: 'Vibrant yellow and orange decorations symbolizing purity and prosperity.',
    },
    {
        icon: Leaf,
        title: 'Natural Decor',
        description: 'Use of marigold flowers and banana leaves for authentic ambiance.',
    },
    {
        icon: Star,
        title: 'Ceremonial Setup',
        description: 'Complete setup for the sacred Haldi ceremony with expert arrangements.',
    },
];

export default function HaldiDecor() {
    return (
        <EventCategoryPage
            category="Haldi"
            heroImage="https://upload.wikimedia.org/wikipedia/commons/d/dc/Haldi_Rasm_at_Indian_Wedding.jpg"
            title="Traditional Haldi Ceremony"
            subtitle="Experience the vibrant traditions of the Haldi ceremony with our exquisite decor"
            buttonText="Plan Your Haldi"
            buttonColor="yellow"
            featureList={haldiFeatures}
        />
    );
}
