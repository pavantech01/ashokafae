...
const birthdayFeatures = [
    {
        ...
        description: 'Customized cakes to match your birthday theme and taste.',
    },
    {
        icon: Gift,
        title: 'Party Favors',
        description: 'Exciting gifts and goodies for your guests.',
    },
    {
        icon: Star,
        title: 'Unforgettable Themes',
        description: 'Creative decorations and experiences tailored to any age.',
    },
];
...
export default function BirthdayParty() {
    return (
        <EventCategoryPage
            category="Birthday"
            heroImage="https://images.unsplash.com/photo-1464349153735-7db50ed83c84?auto=format&fit=crop&q=80"
            title="Make Birthdays Magical"
            subtitle="Throw a birthday party they'll never forget"
            buttonText="Plan Birthday Party"
            featureList={birthdayFeatures}
        />
    );
}
